  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('QUIZ HOLOLIVE ( ${_scoreKeeper.length}/20 )'),
        centerTitle: true,
        elevation: 0.0,
      ),
      backgroundColor: Colors.grey.shade900,
  ...
  _buildQuiz() {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        QuizAnswer(
            answer: _controller.getAnswer1(),
            onTap: () {
              bool correct =
                  _controller.correctAnswer(_controller.getAnswer1());
        ...
        QuizAnswer(
            answer: _controller.getAnswer2(),
            onTap: () {
              bool correct =
                  _controller.correctAnswer(_controller.getAnswer2());
